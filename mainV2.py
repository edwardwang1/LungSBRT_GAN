...
from datasetV2 import VolumesFromList
...
def train(data_dir, train_list_path, test_list_path, save_dir, exp_name_base, exp_name, params):
    ...
    g.cuda()
    d = Discriminator(last_conv_kernalsize=disc_last_layer_ks)
    d.cuda()
                                ...
                                for pretrain_disc_epoch in pretrain_disc_epochs:
                                    for disc_last_layer_ks in disc_last_layer_ksizes:
                                        for c in alt_condition_volume:
                                            ...
                                            exp_name = f'dLR={d_lr}_gLR={g_lr}_A={alpha}_B={beta}_Con={c}_Lo={loss_type}'
